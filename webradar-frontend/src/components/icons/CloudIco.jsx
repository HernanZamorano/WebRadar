const CloudIco = ({ width = 24, height = 24, color = "#000000", ...props }) => {
  return (
    <svg
    ...
    >
      ...
      <path d="M16 19.9999L15 21.9999" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M13 19.9999L12 21.9999" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
