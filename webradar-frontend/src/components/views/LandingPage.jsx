...
function LandingPage() {
  return (
    <div className="min-h-screen flex flex-col">
      {/* Barra de navegación */}
      <header className="bg-blue-700 text-white w-full p-4 flex justify-between items-center">
        {/* Imagen del logo en vez del texto "AlphaNova" */}
        <div>
          <img
        ...
        <nav className="space-x-4">
          <a href="#seccion-principal" className="hover:underline">#seccion principal</a>
          <a href="#section1" className="hover:underline">#section 1</a>
          <a href="#section2" className="hover:underline">#section 2</a>
        </nav>
      ...
      <section className="flex flex-col items-center p-8 bg-gray-100 text-gray-800">
        <div className="max-w-4xl">
          ...
          <p className="text-lg mb-4">
            En Rancagua, la meteorología juega un papel crucial en la comprensión de los patrones climáticos de la región, especialmente en relación con las precipitaciones. El análisis detallado de fenómenos atmosféricos, como la isoterma cero, es fundamental para predecir cambios en el clima y manejar adecuadamente los recursos hídricos. Sin embargo, el proceso tradicional de análisis presenta desafíos en cuanto a la eficiencia y la capacidad de manejar grandes volúmenes de datos en tiempo real. 
            Por ello, se ha vuelto esencial el uso de tecnologías avanzadas que permitan un monitoreo más preciso y automatizado, optimizando así las herramientas disponibles para mejorar la predicción y el análisis del clima en la región.
          </p>
        </div>
          ...
          <div className="lg:w-1/2 lg:mr-6 mb-4 lg:mb-0 flex flex-col items-center lg:items-start">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-gray-700">
                Profesor de la Universidad de O'Higgins (UOH), Rancagua, Chile e Investigador Adjunto del Centro de Investigación en Clima y Resiliencia (CR2). Sus intereses incluyen procesos de precipitación asociados a Ríos Atmosféricos, pronósticos de precipitación y meteorología GPS.
              </p>
            </div>
          </div>
